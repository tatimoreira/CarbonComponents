...
describe('ComboBox', function () {
  ...
  it('should display the placeholder text when no items are selected and the control is not focused', function () {
    var wrapper = (0, _enzyme.mount)(_react.default.createElement(_ComboBox.default, mockProps));
  ...
  it('capture filter text events', function () {
    ...
    var wrapper = (0, _enzyme.mount)(_react.default.createElement(_ComboBox.default, _extends({}, mockProps, {
