...
describe('Slider', function () {
  describe('Renders as expected', function () {
    var mockFn = jest.fn();
    var wrapper = (0, _enzyme.mount)(_react.default.createElement(_Slider.default, {
      id: "slider",
...
describe('SliderSkeleton', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)(_react.default.createElement(_Slider2.default, null));
