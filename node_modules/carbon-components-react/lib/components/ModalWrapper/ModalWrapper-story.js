...
(0, _react2.storiesOf)('ModalWrapper', module).addDecorator(_addonKnobs.withKnobs).add('transactional/passive modal', (0, _addonInfo.withInfo)({
...
})).add('input modal', (0, _addonInfo.withInfo)({
