...
var props = {
  ...
  switch: function _switch() {
    return {
      ...
      kind: (0, _addonKnobs.select)('Butto kind (kind in <Switch>)', kinds, 'anchor'),
      href: (0, _addonKnobs.text)('The link href (href in <Switch>)', ''),
      icon: iconMap[(0, _addonKnobs.select)('Icon (icon in <Switch>)', icons, 'none')]
    };
  }
};
(0, _react2.storiesOf)('ContentSwitcher', module).addDecorator(_addonKnobs.withKnobs).add('Default', (0, _addonInfo.withInfo)({
...
})).add('Selected', (0, _addonInfo.withInfo)({
