...
(0, _react2.storiesOf)('Toolbar', module).add('Default', (0, _addonInfo.withInfo)({
  text: "\n      Toolbar stuff\n    "
})(function () {
  return _react.default.createElement(_Toolbar.default, _extends({}, toolbarProps, {
    ...
    icon: _carbonIcons.iconFilter,
    floatingMenu: true
  }, _react.default.createElement(_Toolbar.ToolbarTitle, {
    title: "FILTER BY"
  }), _react.default.createElement(_Toolbar.ToolbarOption, null, _react.default.createElement(_Checkbox.default, _extends({}, checkboxEvents, {
    id: "opt-1",
    ...
    title: "ROW HEIGHT"
  }), _react.default.createElement(_Toolbar.ToolbarOption, null, _react.default.createElement(_RadioButton.default, {
    value: "short",
    id: "radio-1",
    name: "toolbar-radio",
    labelText: "Short"
