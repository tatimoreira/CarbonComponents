...
var props = {
  timepicker: function timepicker() {
    return {
      pattern: (0, _addonKnobs.text)('Regular expression for the value (pattern in <TimePicker>)', '(1[012]|[1-9]):[0-5][0-9](\\s)?(?i)'),
      placeholder: (0, _addonKnobs.text)('Plceholder text (placeholder in <TimePicker>)', 'hh:mm'),
...
(0, _react2.storiesOf)('TimePicker', module).addDecorator(_addonKnobs.withKnobs).add('Default', (0, _addonInfo.withInfo)({
