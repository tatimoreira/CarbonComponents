...
var props = {
  ...
  expandable: function expandable() {
    return {
      ...
      tileCollapsedIconText: (0, _addonKnobs.text)('Collapsed icon text (tileCollapsedIconText)', 'Expand'),
      tileExpandedIconText: (0, _addonKnobs.text)('Collapsed icon text (tileExpandedIconText)', 'Collapse'),
      handleClick: (0, _addonActions.action)('handleClick')
    };
  }
};
(0, _react2.storiesOf)('Tile', module).addDecorator(_addonKnobs.withKnobs).add('Default', (0, _addonInfo.withInfo)({
  text: "\n        Default tile without any interactions\n      "
})(function () {
  return _react.default.createElement(_Tile.Tile, null, "Default tile");
})).add('Clickable', (0, _addonInfo.withInfo)({
  text: "\n        Clickable tile\n      "
})(function () {
  return _react.default.createElement(_Tile.ClickableTile, {
    href: (0, _addonKnobs.text)('Href for clicable UI (href)', '#')
  }, "Clickable Tile");
})).add('Multi-select', (0, _addonInfo.withInfo)({
  text: "\n        Selectable tile\n\n        Use this to select multiple tiles.\n      "
})(function () {
  var selectableProps = props.selectable();
  return _react.default.createElement("div", null, _react.default.createElement(_Tile.SelectableTile, _extends({
    id: "tile-1",
    name: "tiles"
...
})).add('Selectable', (0, _addonInfo.withInfo)({
...
})).add('Expandable', (0, _addonInfo.withInfo)({
  text: "\n        Expandable tile\n      "
})(function () {
